...
class Iconic_WooThumbs_Core_Settings {
	...
	public static function add_settings_page() {
		$default_title = sprintf( '<div style="padding-bottom: 15px;"><img width="24" height="28" style="display: inline-block; vertical-align: text-bottom; margin: 0 8px 0 0" src="%s"> %s by <a href="https://iconicwp.com/?utm_source=Iconic&utm_medium=Plugin&utm_campaign=iconic-woothumbs&utm_content=settings-title" target="_blank">Iconic</a> <em style="opacity: 0.6; font-size: 80%%;">(v%s)</em></div>', esc_attr( self::$iconic_svg ), self::$args['title'], self::$args['version'] );
	...
	public static function add_sidebar() {
		...
		$cross_sells  = Iconic_WooThumbs_Core_Cross_Sells::get_selected_plugins( self::$args['cross_sells'] );
		$show_bundle  = ! Iconic_WooThumbs_Core_Licence::is_bundle() && Iconic_WooThumbs_Core_Licence::get_license_quota() <= 3;
		...
		<div class="iconic-settings-sidebar">
			...
			<?php if ( $show_bundle ) { ?>
				<div class="iconic-settings-bundle iconic-settings-sidebar__widget iconic-settings-sidebar__widget--bundle">
					...
					<p class="iconic-settings-bundle__secondary-link">or <a href="https://iconicwp.com/bundles/?utm_source=Iconic&utm_medium=Plugin&utm_campaign=iconic-woothumbs&utm_content=bundles-cta" target="_blank">view bundles</a></p>
					...
					<?php foreach ( $cross_sells as $cross_sell ) { ?>
						<div class="iconic-product">
							...
							<div class="iconic-product__content">
								<h4 class="iconic-product__title"><a target="_blank" href="<?php echo esc_url( $cross_sell['url'] ); ?>?utm_source=Iconic&utm_medium=Plugin&utm_campaign=iconic-woothumbs&utm_content=cross-sell" target="_blank"><?php echo esc_html( $cross_sell['title'] ); ?></a></h4>
