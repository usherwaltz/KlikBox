...
class Iconic_WooThumbs_Core_Cross_Sells {
	...
	private static function get_plugins() {
		return array(
			...
			'iconic-woo-sales-booster'                => array(
				...
				'description' => __( 'Use proven cross-selling techniques to increase the average order value of your store.', 'iconic-woothumbs' ),
			...
			'flux-checkout'                           => array(
				...
				'description' => __( 'Prevent abandoned carts with a slick multi-step checkout experience, designed for your customer’s device.', 'iconic-woothumbs' ),
	...
	public static function get_output() {
		...
		$utm = '?utm_source=Iconic&utm_medium=Plugin&utm_campaign=iconic-woothumbs&utm_content=cross-sell';
		...
		<div class="iconic-cross-sells-wrapper">
			<div class="iconic-cross-sells-columns iconic-cross-sells-columns--plugins">
							...
							<div class="iconic-cross-sell__border">
								...
								<div class="iconic-cross-sell__footer">
									<a class="iconic-cross-sell__link button-secondary" href="<?php echo esc_attr( $cross_sell['url'] . $utm ); ?>" target="_blank">
										<?php echo esc_html( __( 'Learn More', 'iconic-woothumbs' ) ); ?>
				...
				<a href="https://iconicwp.com/products/<?php echo esc_url( $utm ); ?>" class="button-secondary"><?php echo esc_html( __( 'View All Iconic Plugins', 'iconic-woothumbs' ) ); ?></a>
			</div>

			<div class="iconic-cross-sells-columns iconic-cross-sells-columns--testimonials">
				<p class="iconic-trust">
					<span class="dashicons dashicons-thumbs-up"></span> <?php echo esc_html( __( 'Trusted by over 10,000 WooCommerce Businesses and Online Shops', 'iconic-woothumbs' ) ); ?>
				</p>
				<?php foreach ( self::$selected_plugins as $cross_sell ) { ?>
					<?php
