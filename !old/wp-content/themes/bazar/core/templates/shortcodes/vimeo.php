...
<div class="post_video vimeo" <?php echo $style_container;?>>
    <iframe wmode="transparent" src="//player.vimeo.com/video/<?php echo $video_id; ?>?title=0&amp;byline=0&amp;portrait=0" width="<?php echo $width; ?>" height="<?php echo $height; ?>" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen <?php echo $style_iframe;?>></iframe>
</div>