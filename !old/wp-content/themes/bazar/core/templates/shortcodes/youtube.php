...
<div class="post_video youtube" <?php echo $style_container;?>>
    <iframe wmode="transparent" width="<?php echo $width; ?>" height="<?php echo $height; ?>" src="//www.youtube.com/embed/<?php echo $video_id; ?>?wmode=transparent" frameborder="0" allowfullscreen <?php echo $style_iframe; ?>></iframe>
</div>