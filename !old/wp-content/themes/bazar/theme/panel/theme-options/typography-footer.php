...
add_filter( 'yit_footer-links-font_std', 'filter_yit_footer_links_font_std' );
add_filter( 'yit_footer-links-hover-font_std', 'filter_yit_footer_links_hover_font_std' );
add_filter( 'yit_copyright-links-font_std', 'filter_yit_copyright_links_font_std' );
add_filter( 'yit_copyright-links-hover-font_std', 'filter_yit_copyright_links_hover_font_std' );

function filter_yit_footer_links_font_std() { return '#282828'; }
function filter_yit_footer_links_hover_font_std() { return '#AA620D'; }
function filter_yit_copyright_links_font_std() { return '#282828'; }
function filter_yit_copyright_links_hover_font_std() { return '#e3910f'; }
