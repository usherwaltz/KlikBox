...
function filter_yit_call_to_action_title_std() {
    return array(
        'size'   => 20,
        'unit'   => 'px',
        'family' => 'Oswald',
...
add_filter( 'yit_call-to-action-title_std', 'filter_yit_call_to_action_title_std' );

function filter_yit_call_to_action_incipit_std() {
    return array(
        'size'   => 14,
        'unit'   => 'px',
        'family' => 'Play',
...
add_filter( 'yit_call-to-action-incipit_std', 'filter_yit_call_to_action_incipit_std' );

function filter_yit_call_to_action_phone_std() {
    return array(
        'size'   => 42,
        'unit'   => 'px',
        'family' => 'Play',
...
add_filter( 'yit_call-to-action-phone_std', 'filter_yit_call_to_action_phone_std' );

function filter_yit_call_to_action_button_text_std() {
    return array(
        'size'   => 20,
        'unit'   => 'px',
        'family' => 'Oswald',
...
add_filter( 'yit_call-to-action-button-text_std', 'filter_yit_call_to_action_button_text_std' );

function filter_yit_call_to_action_button_background_std() { return "#eeeeee"; }
add_filter( 'yit_call-to-action-button-background_std', 'filter_yit_call_to_action_button_background_std' );

function filter_yit_call_to_action_button_border_std() { return "#cfcece"; }
add_filter( 'yit_call-to-action-button-border_std', 'filter_yit_call_to_action_button_border_std' );
