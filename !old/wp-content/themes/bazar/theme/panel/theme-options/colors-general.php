...
function yit_tab_colors_general( $fields ) {
    ...
    return array_merge( $fields, array(
        ...
        160 => array(
            ...
            'style' => array(
                'selectors' => '.sidebar .widget .minus',
                'properties' => 'background-color'
            )
        ),
        170 => array(
...
add_filter( 'yit_general-border_std', 'filter_yit_general_border_std' );
function filter_yit_general_border_std() { return "#e0dfdf"; }
...
add_filter( 'yit_general-border-hover_std', 'filter_yit_general_border_hover_std' );
function filter_yit_general_border_hover_std () { return "#cccccc"; }
