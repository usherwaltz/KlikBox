...
if ( ! has_action( 'yit_after_header', 'yit_slider_space' ) ) add_action( 'yit_after_header', function(){ echo "<div style='height:100px;'></div> "; } );
?>
                ...
                <?php
$script = ob_get_clean();
add_action( 'wp_footer', function() use( $script ){ echo stripslashes( addslashes( $script ) ); }, 20 );
