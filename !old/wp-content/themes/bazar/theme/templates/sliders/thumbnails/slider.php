...
if ( ! has_action( 'yit_after_header', 'yit_slider_space' ) ) {
    add_action( 'yit_after_header', 'filter_yit_after_header' );
}
function filter_yit_after_header() { echo "<div style='height:130px;'></div>"; }
?>
