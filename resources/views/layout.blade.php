...
{{--    <link rel="preload" as="style" href="{{asset('css/bootstrap.min.css')}}" onload="this.rel='stylesheet'">--}}
    ...
    <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
        ...
        })(window,document,'script','dataLayer','GTM-5D2HSM4');</script>
    ...
    <script>
        ...
        fbq('init', '352402806486199');
        fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
                   src="https://www.facebook.com/tr?id=352402806486199&ev=PageView&noscript=1"
        /></noscript>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MDBSTN2"
